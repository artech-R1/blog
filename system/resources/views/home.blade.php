                ...
                <div class="main box-border">
                    <div id="mi-slider" class="mi-slider">
                        <ul>
                            ...
                            <li><a href="#">
                                    <img src="{{url('public')}}/assets/ItemSlider/images/1.jpg" alt="img01">
                                    <h4>Boots</h4>
                                </a></li>
                            <li><a href="#">
                                    <img src="{{url('public')}}/assets/ItemSlider/images/2.jpg" alt="img02">
                                    <h4>Oxfords</h4>
                                </a></li>
                            <li><a href="#">
                                    <img src="{{url('public')}}/assets/ItemSlider/images/3.jpg" alt="img03">
                                    <h4>Loafers</h4>
                                </a></li>
                            <li><a href="#">
                                    <img src="{{url('public')}}/assets/ItemSlider/images/4.jpg" alt="img04">
                                    <h4>Sneakers</h4>
                                </a></li>
                        </ul>
                        <ul>
                            <li><a href="#">
                                    <img src="{{url('public')}}/assets/ItemSlider/images/5.jpg" alt="img05">
                                    <h4>Belts</h4>
                                </a></li>
                            <li><a href="#">
                                    <img src="{{url('public')}}/assets/ItemSlider/images/6.jpg" alt="img06">
                                    <h4>Hats &amp; Caps</h4>
                                </a></li>
                            <li><a href="#">
                                    <img src="{{url('public')}}/assets/ItemSlider/images/7.jpg" alt="img07">
                                    <h4>Sunglasses</h4>
                                </a></li>
                            <li><a href="#">
                                    <img src="{{url('public')}}/assets/ItemSlider/images/8.jpg" alt="img08">
                                    <h4>Scarves</h4>
                                </a></li>
                        </ul>
                        <ul>
                            <li><a href="#">
                                    <img src="{{url('public')}}/assets/ItemSlider/images/9.jpg" alt="img09">
                                    <h4>Casual</h4>
                                </a></li>
                            <li><a href="#">
                                    <img src="{{url('public')}}/assets/ItemSlider/images/10.jpg" alt="img10">
                                    <h4>Luxury</h4>
                                </a></li>
                            <li><a href="#">
                                    <img src="{{url('public')}}/assets/ItemSlider/images/11.jpg" alt="img11">
                                    <h4>Sport</h4>
                                </a></li>
                        </ul>
                        <ul>
                            <li><a href="#">
                                    <img src="{{url('public')}}/assets/ItemSlider/images/12.jpg" alt="img12">
                                    <h4>Carry-Ons</h4>
                                </a></li>
                            <li><a href="#">
                                    <img src="{{url('public')}}/assets/ItemSlider/images/13.jpg" alt="img13">
                                    <h4>Duffel Bags</h4>
                                </a></li>
                            <li><a href="#">
                                    <img src="{{url('public')}}/assets/ItemSlider/images/14.jpg" alt="img14">
                                    <h4>Laptop Bags</h4>
                                </a></li>
                            <li><a href="#">
                                    <img src="{{url('public')}}/assets/ItemSlider/images/15.jpg" alt="img15">
                                    <h4>Briefcases</h4>
                                </a></li>
                        </ul>
                        <nav>
                    ...
                    <div class="col-md-4 text-center col-sm-6 col-xs-6">
                        <div class="thumbnail product-box">
                            ...
                            <div class="caption">
                                ...
                                <p><a href="#" class="btn btn-success" role="button">Add To Cart</a> <a href="{{url('/produk')}}"class="btn btn-primary" role="button">See Details</a></p>
                            </div>
                        </div>
                    </div>
                    <!-- /.col -->
                        ...
                        <div class="thumbnail product-box">
                            ...
                            <div class="caption">
                                ...
                                <p>
                                    ...
                                    <a href="{{url('/produk')}}" class="btn btn-primary" role="button">See Details</a>
                                </p>
                            </div>
                        </div>
                    </div>
